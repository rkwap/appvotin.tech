...
<body>
    <nav class="navbar navbar-expand-md fixed-top">
        <div class="container">
            <div class="navbar-translate">
                ...
                <a class="navbar-brand" href="https://www.creative-tim.com">AppVotin!</a>
            </div>
            <div class="collapse navbar-collapse" id="navbarToggler">
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php } else { ?>
                        <li class="nav-item">
                        <form data-toggle="validator" action="members/signInOutUp.php" method="post" accept-charset="utf-8">
                        <button href="#loginModal" type="button" class="btn btn-danger btn-round" data-toggle="modal" data-target="#loginModal">
                        Login
                        </button>
					</li>
                  <?php  } ?>
 ...
 <!-- login modal -->
  ...
  <!--<div modal-render="true" class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-hidden="false" uib-modal-animation-class="fade" modal-in-class="in" ng-style="{'z-index': 1050 + index*10, display: 'block'}" uib-modal-window="modal-window" size="md" index="0" animate="animate" modal-animation="true" style="z-index: 1050; display: block;">-->
    <div class="modal-dialog modal-register">
      <div class="modal-content">
        <div class="modal-header no-border-header text-center">
          ...
          <h3 class="modal-title text-center">AppVotin!</h3>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input name="password" type="password" value="" placeholder="Password" class="form-control" required />
          </div>
          <button type="submit" name="login" class="btn btn-block btn-round"> Log in</button>
          </form>
        </div>
        <div class="modal-footer no-border-footer">
               
           
          <span class="text-muted  text-center">Haven't created an account yet?
            <form action="members/signInOutUp.php" data-toggle="validator" enctype="multipart/form-data" method="post">
            <button type="button" data-target="#signupModal" data-toggle="modal" data-dismiss="modal">Sign up here!</button></span>
...
<!--end of login modal -->
<!-- signup modal -->
  <div class="modal fade" id="signupModal" tabindex="1" role="dialog" aria-hidden="false">
    <div class="modal-dialog modal-register modal-lg">
      <div class="modal-content">
        <div class="modal-header no-border-header text-center">
          ...
          <h3 class="modal-title text-center">AppVotin!</h3>
          <p>Register here to start votin!</p>
        </div>
        <div class="modal-body">
        <div class="row">    
          ...
          <div class="form-group col-lg-4">
            ...
            <input name="username" data-minlength="3" type="username" value="" placeholder="Username" class="form-control" required />
          ...
          <div class="form-group col-lg-4">
            ...
            <input name="firstName" type="text" value="" placeholder="First Name" class="form-control" required />
          </div>
          <div class="form-group col-lg-4">
            <label>Last Name</label>
            <input name="lastName" type="text" value="" placeholder="Last Name" class="form-control" required/>
          </div>
          <div class="form-group col-lg-4">
            <label>Gender</label>
            <div class="form-check-radio">
              <label class="form-check-label">
                <input class="form-check-input" name="gender" value="1" type="radio" checked> Female
                <span class="form-check-sign"></span>
              </label>
            </div>  
            <div class="form-check-radio">  
                <label class="form-check-label">
                <input class="form-check-input" name="gender" value="0" type="radio"> Male
                <span class="form-check-sign"></span>
                </label>
            </div>
          </div>
          ...
          <div class="form-group col-lg-4">
            ...
            <input name="password" data-minlength="6" id="inputPassword" type="password" value="" placeholder="Password" class="form-control" required/>
            <div class="help-block">Minimum of 6 characters</div>
          </div>
          
          <div class="form-group col-lg-4">
            <label>Confirm Password</label>
            <input name="confirmPassword" type="password" id="inputPasswordConfirm" data-match="#inputPassword" data-match-error="Whoops, Confirm password doesn't match password" value="" placeholder="Confirm Password" class="form-control" required />
            <div class="help-block with-errors"></div>
          </div>
          ...
          <div class="form-group col-lg-4">
          <button type="submit" name="signup" class="btn btn-block btn-round">Sign Up!</button>
          </div>
          </div>
          </form>
        </div>
         <div class="col-lg-4">
            <span class="text-muted  text-center">Forgot Password? Don't Worry.
            <form action="members/signInOutUp.php" data-toggle="validator" enctype="multipart/form-data" method="post">
            <button type="button" data-target="#forgotModal" data-toggle="modal" data-dismiss="modal">Click Here!</button></span>
        </div>
        <div class="modal-footer no-border-footer">
          <span class="text-muted  text-center">Already Have an account?
            <button data-dismiss="modal" data-toggle="modal" data-target="#loginModal">Sign in here!</button></span>
        </div>
      </div>
    </div>
  </div>     
    ...
    <div class="modal-dialog modal-register">
      <div class="modal-content">
        <div class="modal-header no-border-header text-center">
          ...
          <p>Don't Worry and Be Happy coz you just proved that you are a <b>Human</b>!</p>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label>Just enter you Email and we will help you with your password recovery.</label>
            <input name="email" type="email" value="" placeholder="Email" class="form-control" required />
          </div>
          <button type="submit" name="forgot" class="btn btn-block btn-round"> Log in</button>
          </form>
        </div>
        <div class="modal-footer no-border-footer">
            <div class="row">
          ...
          <span class="text-muted  text-center">Haven't created an account yet?
            ...
            <span class="text-muted  text-center">Already Have An Account?
            <form action="members/signInOutUp.php" data-toggle="validator" enctype="multipart/form-data" method="post">
            <button type="button" data-target="#loginModal" data-toggle="modal" data-dismiss="modal">Sign in here!</button></span>
            </div>
            </div>
        </div>
      </div>
				...
				<div class="container text-center">
                    ...
                    <div class="row text-center upgrade-pro">
    					<div class="col-md-8 ml-auto mr-auto">
    	                    ...
    	                    <p class="description">We've just launched <a href="http://demos.creative-tim.com/paper-kit-2-pro/presentation.html?ref=utp-pk2-demos" class="text-danger" target="_blank">AppVotin!</a>. It has a huge number of components, sections and example pages.</p>
    	                </div>
