...
################################
    ...
    $raw_results = mysql_query("SELECT * FROM apps
    WHERE (`name` LIKE '$app_title[$i]') OR (`publisher` LIKE '$publisher_title[$i]') ") or die(mysql_error());
